...
public class COSClientUtil {
    private static final String SECRETID = "AKID0oMckcKXbOwGLBu36tPffz2oSt4DEXIn";
    private static final String SECRETKEY = "MUMxIM9fwPbXBYe8TSAbojOBdpkmYAYg";
    private static final String APPID = "1301715174";
    private static final String BUCKETNAME = "demo" + "-" + APPID; // 桶的名称
    private static final String REGIONID = "ap-guangzhou";// 区域
